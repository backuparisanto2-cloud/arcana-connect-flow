...
import { Route as ApiMrtgSplatRouteImport } from './routes/api/mrtg/$'
...
const ApiMrtgSplatRoute = ApiMrtgSplatRouteImport.update({
  id: '/api/mrtg/$',
  path: '/api/mrtg/$',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/api/mrtg/$': typeof ApiMrtgSplatRoute
}
...
export interface RootRouteChildren {
  ...
  ApiMrtgSplatRoute: typeof ApiMrtgSplatRoute
}
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/api/mrtg/$': {
      ...
      path: '/api/mrtg/$'
      fullPath: '/api/mrtg/$'
      preLoaderRoute: typeof ApiMrtgSplatRouteImport
      parentRoute: typeof rootRouteImport
    }
  }
}
...
const rootRouteChildren: RootRouteChildren = {
  ...
  ApiMrtgSplatRoute: ApiMrtgSplatRoute,
}
